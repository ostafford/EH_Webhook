...
| APRA super (USI + member number) | SMSF super; per-employee salary. Company-wide award / classification / pay category / standard hours are an opt-in `employmentHero.defaults` add-on — see [`eh-pay-defaults.md`](./eh-pay-defaults.md) (#26) |
